...
<html lang="pt">
    <head>
		...
		<link rel="shortcut icon" href="pics/AtScoon.jpg" type="image/x-icon"> 
    ...
    <body role="image" background="pics/fundo.jpg">
        <div class="container">
			...
			<section class="main"> 
				<form class="form-2" method="post" action="valida-login.php" >
				 	<div class="panel panel-table">
				 		<p class="clearfix">	
							<div  class="panel-primary panel-heading text-center" ><H2 class="panel-title "  >Sistema de Gerenciamento Escolar</H2>
						</p>
					...
					<div align="center">
					<p class="clearfix">
						<img src="pics/AtScoon.jpg" class="img-responsive" id="logo.jpg" alt="responsive image">
					</p>
					</div>
					...
					<br>
					<p class="clearfix">   
						<input class="btn btn-lg btn-primary center" class="st" id="bt" type="submit" name="Submit" value="Entrar" />
					</p>
