    ...
    <div class="panel panel-default panel-table">
        ...
        <form class="form-horizontal" name="cadastrarEstudante" method="POST" >
          ...
          <div class="col-sm-12">
			  ...
			  <div class="col-sm-4">
				Número de CPF:
				  <input type="text" class="input-sm form-control" name="biCandidato" value="<?php echo $resultado['numeroBI']?>" placeholder="Número de CPF" required="">
				  <input type="hidden" class="input-sm form-control" name="id" value="<?php echo $resultado['numeroBI']?>" placeholder="Número de CPF" required="">
				</div>
